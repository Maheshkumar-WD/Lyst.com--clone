    ...
    <>
      <Flex>
        ...
        <Image
          onClick={onOpen}
          width="150px"
          src="https://www.isite.lk/images/google.png"
        />
      </Flex>
      <Modal isOpen={isOpen} size={sizes} onClose={onClose}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader margin={"auto"}>Download Lyst</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <Image
              width={"150px"}
              margin="auto"
              src={
                "https://www.unitag.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftemplate_classic.746b0922.png&w=3840&q=75"
              }
              alt="scanner"
            />
            <Box display="flex" alignItems="center" flexDirection={"column"}>
              <Text fontSize="24px">Scan the code on your phone</Text>
              ...
              <Box paddingTop="24px">
                <Image src="https://static.lystit.com/static/n/web/react/components/qrcode-overlay/images/get-app-phone.ba25ca91295f8c2fa372763d098933cd.png" />
              </Box>
            </Box>
          </ModalBody>
        </ModalContent>
...
export default OpenAppStoreModel;
